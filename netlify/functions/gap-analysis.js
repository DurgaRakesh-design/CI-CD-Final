const { CORS_HEADERS, json, parseEventBody, compactSignals, callOpenAI } = require("./_shared");
...
async function analyzeWithAI(signals, documents) {
  ...
  const user = JSON.stringify({
    expectedOutput: {
      ...
      findings: "Array of {severity,title,description,relatedDocument,module,packageSignal,impact,recommendedFix}.",
