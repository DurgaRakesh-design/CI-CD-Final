    ...
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
      <section className="rounded-2xl border border-white/80 bg-white/90 p-5 shadow-sm backdrop-blur-xl md:p-6">
        <div className="grid gap-5 md:grid-cols-[minmax(0,1fr)_auto] md:items-center">
          <div>
            <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-primary">Run #{run.runNumber}</p>
            <h2 className="mt-2 font-heading text-xl font-bold tracking-tight md:text-2xl">Pipeline execution evidence</h2>
  ...
  return (
    <section className="rounded-2xl border border-white/80 bg-white/90 p-5 shadow-sm backdrop-blur-xl md:p-6">
      ...
      <div className="mt-4 overflow-hidden rounded-xl border border-border">
        <div className="grid grid-cols-[1fr_1.3fr_100px_80px] bg-muted/70 px-4 py-3 text-[11px] font-bold uppercase tracking-[0.16em] text-muted-foreground">
          <span>Suite</span>
          <span>Test</span>
          <span>Status</span>
        ...
        <section className="rounded-2xl border border-white/80 bg-white/90 p-6 shadow-[0_24px_90px_-50px_rgba(79,70,229,.55)] backdrop-blur-2xl md:p-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-4 font-heading text-2xl font-bold tracking-tight md:text-3xl">{run.projectName}</h1>
